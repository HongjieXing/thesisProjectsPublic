...
if __name__ == '__main__':
    ...
    import csv
    paras = []
    resultPath = './result of job 2024-04-05 20h-43m-23s/optPop/' 
    ...
    plt.text(-0.035, 0.045, '0.06', fontsize=28,color="#ae3ec9")
    ...
    ax.scatter(HF[54], objvs[54,1], c='#c00000', marker='v', s=150, alpha=0.8, label='Selected')
    # plt.gca().yaxis.set_major_formatter(plt.FuncFormatter(lambda x, pos: '{:.1%}'.format(x)))  #设置y轴坐标为{:.1%}
    ...
    plt.grid(True, which='major', linestyle=':',color='0',axis='x',linewidth=2,alpha=0.3)
    # plt.axhline(y = 0.06, color='#ae3ec9',linestyle='--',linewidth = 2)
    # plt.axvline(x = 20, color='#ae3ec9',linestyle='--',linewidth = 2)
    # plt.text(9.9, 0.045, '0.06', fontsize=28,color="#ae3ec9")
    # plt.text(21, 0.4, '20.0', fontsize=28,color="#ae3ec9")
